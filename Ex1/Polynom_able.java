...
/**
 * This interface represents a general myMath.Polynom: f(x) = a_1X^b_1 + a_2*X^b_2 ... a_n*Xb_n,
 ...
 * 1.3 myMath.Polynom copy() // deep copy semantics
 * 
 * 2. Math:
 ...
 * 3. Utils
 * 3.1 isZero()
 * 3.2 myMath.Polynom derivative() // returns a new Polygon of the derivative ("NIGZERET").
...
public interface Polynom_able extends cont_function{
	/**
	 * Add p1 to this myMath.Polynom
	 * @param p1
	 */
	public void add(Polynom_able p1);
	/**
	 * Add m1 to this myMath.Polynom
	 * @param m1 Monom
	 */
	public void add(Monom m1);
	/**
	 * Subtract p1 from this myMath.Polynom
	 * @param p1
	 */
	public void substract(Polynom_able p1);
	/**
	 * Multiply this myMath.Polynom by Monom m1
	 * @param m1
	 */
	public void multiply(Monom m1);
	/**
	 * Multiply this myMath.Polynom by p1
	 * @param p1
	 */
	public void multiply(Polynom_able p1);
	/**
	 * Test if this myMath.Polynom is logically equals to p1.
	 * @param p1
	 * @return true iff this polynom represents the same function as p1
	 */
	public boolean equals (Object p1);
	/**
	 * Test if this is the Zero myMath.Polynom
	 * @return
	 */
	public boolean isZero();
	
	/**
	 * create a deep copy of this myMath.Polynom
	 * @return 
	 */
	public Polynom_able copy();
	/**
	 * Compute a new myMath.Polynom which is the derivative of this myMath.Polynom
	 * @return
	 */
	public Polynom_able derivative();
	/**
	 * @return an Iterator (of Monoms) over this myMath.Polynom
	 * @return
	 */
